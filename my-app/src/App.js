...
function App() {
  ...
  const handleInput = () => {
    ...
    if (words8.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "My name is DivBot";
        inputRef.value = "";
      }, 2000);
    }
    ...
    if (words9.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "The owner of this bot is Divya";
        inputRef.value = "";
      }, 2000);
    }

    let owner2 = ["Who's Divya|who's Divya|Who is Divya|who is Divya"];
    let words10 = new RegExp(owner2);
    if (words10.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText =
          "Divya is a programmer based on ReactJS.She is the owner of a youtube channel called Creative Tutorials";
        inputRef.value = "";
      }, 2000);
    }
    ...
    if (words11.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "I am 1month old";
        inputRef.value = "";
      }, 2000);
    }
